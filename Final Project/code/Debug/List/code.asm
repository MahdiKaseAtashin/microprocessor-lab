...
; 0000 0055 ACSR=0x80;
	LDI  R30,LOW(128)
	OUT  0x8,R30
; 0000 0056 SFIOR=0x00;while (1)
	LDI  R30,LOW(0)
	OUT  0x30,R30
_0x3:
; 0000 0057 {
; 0000 0058 // Place your code here
; 0000 0059 sensd=0b00011111;
	LDI  R30,LOW(31)
	MOV  R5,R30
; 0000 005A sensd=PIND&sensd;
	IN   R30,0x10
	AND  R5,R30
; 0000 005B if(sensd==0b00000100)
	LDI  R30,LOW(4)
	CP   R30,R5
	BRNE _0x6
; 0000 005C forward();
	RCALL _forward
; 0000 005D if(sensd==0b00001110)
_0x6:
	LDI  R30,LOW(14)
	CP   R30,R5
	BRNE _0x7
...
; 0000 0072 left();
	RCALL _left
; 0000 0073 //*****************************TAGHIR RANG
; 0000 0074 if(sensd==0b11111011)
_0x11:
	LDI  R30,LOW(251)
	CP   R30,R5
	BRNE _0x12
